...
bcsHeaderUI <- function(id, appname) {
  ...
  htmltools::tagList(
    ## Header Styles
    htmltools::tags$head(htmltools::tags$style(htmltools::HTML('#header_col {background-color:#003366; border-bottom:2px solid #fcba19; position:fixed; z-index:10000; margin-top:50px"}'))),
